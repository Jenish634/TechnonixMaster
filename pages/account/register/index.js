...
const RegisterScreen = (props) => {
      ...
      if (password === confirmpassword) {
        ...
        props.register({
          ...
          callback: (reponse, data) => {
            ...
            if (
              _.chain(props)
                .get("nativeLoadingOverlaySpinner.close")
                .isFunction()
                .value()
            ) {
  ...
  const validateForm = (callback) => {
    if (firstName == null) {
      ...
      countryDetailsVisible == {} ||
      _.isEmpty(countryDetailsVisible)
    ) {
          ...
          <View style={style.modalView}>
            <View style={style.FormGroup}>
              ...
              <Text style={style.FormLabel}>
                Manage the team templates that your end users see by creating
                templates policies in the admin center. Within each template
                policy, you can designate which templates are shown or hidden.
                Assign different users to different template policies so that
                your users view only the subset of team templates specified.
              </Text>
            </View>
          </View>
        </View>
            ...
            >
              ...
              <TouchableOpacity onPress={() => setCountryModalVisible(true)}>
                ...
                >
                  <Text
                    style={{
                      marginTop: 8,
                      color: _.get(countryDetailsVisible, "name")
                        ? "black"
                        : "gray",
                    }}
                  >
                    ...
                    {_.get(countryDetailsVisible, "callingCode[0]") &&
                      `(+${_.get(countryDetailsVisible, "callingCode[0]")})`}
                  </Text>
                </View>
              </TouchableOpacity>
              ...
              >
                ...
                {confirmIcon && (
                  ...
                  >
                    <Entypo
                      name={confirmSecure ? "eye" : "eye-with-line"}
                      size={15}
                      color="black"
                    />
                  </TouchableOpacity>
              ...
              >
                ...
                <TouchableOpacity onPress={() => setModalVisible(true)}>
                  <Text
                    style={{ margin: 8, fontStyle: "italic", color: "grey" }}
                  >
                    Accept Policies
                  </Text>
                </TouchableOpacity>
              ...
              <View>
                <TouchableOpacity
                  onPress={() => formSubmit()}
                  disabled={
                    _.get(props, "loading", false) || isSelected == false
                  }
                  style={{
                    height: 45,
                    backgroundColor: isSelected ? "#08356D" : "grey",
                    alignItems: "center",
                    justifyContent: "center",
                  }}
                >
              ...
              >
                <View style={{ flexDirection: "row" }}>
                  ...
                  <TouchableOpacity
                    disabled={_.get(props, "loading", false)}
                    onPress={() => Actions.AccountLoginScreen()}
                  >
                    <Text style={{ color: "#08356D", fontSize: 18 }}>
                      Sign In
                    </Text>
                  </TouchableOpacity>
                </View>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(nativeLoadingOverlaySpinner(RegisterScreen));
