  ...
  const render = () => {
    return (
      <View style={{ backgroundColor: "white", flex: 1 }}>
        ...
        >
          <Image
            style={{ height: 200, width: 200, marginTop: 120 }}
        ...
        <View style={{ flex: 2, paddingHorizontal: windowWidth * 0.11 }}>
          ...
          >
            ...
            {eyeIcon && (
              ...
              onPress={()=>{
               ...
               style={{justifyContent:'flex-end',flexDirection:'row',flex:1,paddingRight:15,marginTop: windowHeight * 0.015,}}>
              <Entypo name={secure? "eye" : "eye-with-line"} size={15} color="black" />
            </TouchableOpacity>
            )}
          ...
          <View
            style={{ alignItems: "flex-end", paddingTop: windowHeight * 0.02 }}
          >
            <TouchableOpacity onPress={() => Actions.AccountForgotScreen()}>
              <Text style={{ color: "#08356D", fontSize: 16 }}>
                Forgot Password?
              </Text>
            </TouchableOpacity>
          </View>
        ...
        >
          <View style={{ flexDirection: "row" }}>
            ...
            <TouchableOpacity
              disabled={_.get(props, "loading", false)}
              onPress={() => Actions.AccountRegisterScreen()}
            >
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(nativeLoadingOverlaySpinner(LoginScreen));
