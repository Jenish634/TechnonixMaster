    ...
    return (
      ...
      <View style={{ height: 46 }}>
        ...
        <View style={{ flexDirection: 'row', paddingLeft: 15, paddingTop: 12 }}>
          ...
          <View style={{ flexDirection: 'row', width: windowWidth * 0.81, height: 36, borderRadius: 15, borderWidth: 1, borderColor: 'rgba(8, 53, 109, 0.3)', marginLeft: 8 }}>
            <TextInput
            value={messageText}
              onChangeText={text => onChangeMessageText(text)}
              style={{ width: windowWidth * 0.70, height: 36, paddingLeft: 15 }}></TextInput>
        ...
        <View style={{ paddingHorizontal: hp('2'), height: hp('12'), paddingTop: hp('5'), backgroundColor: '#08356D', flexDirection: 'row', alignItems: 'center', paddingBottom: 5 }}>
         ...
         <View style={{ paddingLeft: 12 }}>
            <Image style={{ width: 42, height: 40, borderRadius: 15 }}
              ...
              source={_.get(props,'conversationParams.name.photoUrl')!='no-photo.jpg'? {uri:_.get(props,'conversationParams.name.photoUrl')}
